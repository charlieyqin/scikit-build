...
and `CMAKE_OSX_ARCHITECTURES`_ CMake options and automatically used to configure
...
the example above, the options used to configured the associated CMake project
are::
